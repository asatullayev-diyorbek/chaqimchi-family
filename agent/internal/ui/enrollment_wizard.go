...
func ShowEnrollment(ctx context.Context, code, qrPayload string, expiresAt time.Time, wait func(context.Context, func(error)) error, onLinked func(func(string)) error) error {
	...
	err = d.Dialog{
		...
		FixedSize:  true,
		Size:       d.Size{Width: 440, Height: 552},
		Layout:     d.VBox{MarginsZero: true, Spacing: 0},
		Children: []d.Widget{
			headerBand("4 / 5"),
			d.Composite{
				Background: solid(colorCanvas),
				Layout:     d.VBox{Margins: d.Margins{Left: 24, Top: 18, Right: 24, Bottom: 16}, Spacing: 9},
				Children: []d.Widget{
					...
					card(d.Margins{Left: 14, Top: 14, Right: 14, Bottom: 12}, 8,
						...
						d.Label{Text: "yoki bu kodni kiriting", Font: fontOf(8, false), TextColor: colorFaint, Alignment: d.AlignHCenterVNear},
						d.Label{Text: spacedCode(code), Font: fontOf(22, true), TextColor: colorAccent, Alignment: d.AlignHCenterVNear},
					),
					d.VSpacer{},
					...
					footerButtons(
						d.PushButton{AssignTo: &cancelBtn, Text: "Bekor qilish", MinSize: d.Size{Width: 104, Height: 30}, OnClicked: func() { stop(); dlg.Cancel() }},
						d.HSpacer{},
					),
				},
			},
